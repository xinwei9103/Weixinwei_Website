...
<div class="container content">
    <div class="row">
        ...
        <div class="col-sm-6">
            <form role="form" action="/createAccount" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label><span class="glyphicon glyphicon-asterisk"></span> Access Code</label>
                    <input type="text" class="form-control" name="access" placeholder="Access Code">
                </div>
